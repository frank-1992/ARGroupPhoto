...
namespace RenderHeads.Media.AVProMovieCapture
{
	...
	public class CaptureFromCamera360ODS : CaptureBase
	{
		...
		public class Settings
		{
			...
			[SerializeField]
			public CameraSelector cameraSelector = null;
			...
			[SerializeField]
			public Behaviour[] cameraImageEffects = null;
		}
		...
		{
			if (_settings.cameraSelector != null)
			{
				if (_settings.camera != _settings.cameraSelector.Camera)
				{
					SetCamera(_settings.cameraSelector.Camera);
				}
			}
